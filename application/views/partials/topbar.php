      ...
      <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $this->session->userdata('username'); ?></span><br>
                  <?php
                    ...
                    if (!empty($id_roles)) {
                        ...
                        $query = $this->db->select('nama_roles')
                            ->where('id_roles', $id_roles)
                            ->get('roles');

                        if ($query->num_rows() > 0) {
                            $role_name = $query->row()->nama_roles;
                            echo '<span class="mr-2 d-none d-lg-inline text-gray-600 small">' . $role_name . '</span>';
                        }
                    }
                    ?>
